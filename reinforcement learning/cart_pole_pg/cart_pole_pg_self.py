...
learning_rate = 1e-2
batch_size = 1 # every how many episodes to do policy gradient update
gamma = 0.99
...
#      env.render()
      ...
      if done == True:
         ...
         if current_episode % batch_size == 0:
            ...
            print("Average reward for batch %.0f: %.2f" % (current_episode, reward_sum/batch_size))
